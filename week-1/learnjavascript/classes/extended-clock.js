...
class superClock extends Clock {
  constructor(props){
    super(props);
    let { template,precision} = props;
...
const fastClock = new superClock({ template: 'h:m:s',precision : 0 });
fastClock.start()


//по-моему, я немного намутил с деструктуризацией, интуитивно думаю что можно было бы сделать как-то изящнее. Но работает